  ...
  my: {
    ...
    client: {
      ...
      infoModal: {
        ...
        step3Title: 'Beri Emel / Tunjuk QR Kod:',
        step3Desc: 'Berikan emel berdaftar anda atau tunjukkan QR Kod pada kad untuk diimbas oleh kamera staff kaunter.',
  ...
  en: {
    ...
    client: {
      ...
      infoModal: {
        ...
        step3Title: 'State Email / Show QR Code:',
        step3Desc: 'Provide your registered email or show your profile QR Code on your card for staff to scan.',
