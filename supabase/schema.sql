...
-- Backward compatibility columns (jadual ni mungkin dah wujud dari versi lama
-- yang tiada lajur-lajur ni, jadi "create table if not exists" di atas jadi
-- no-op dan index kat email akan gagal tanpa alter table ni)
